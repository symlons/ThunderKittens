...
| `test_fp8_bwd_kernel.py` | `fp8_suite.test_backward_kernel`  | backward sweep with the CUDA kernel; also validates per-token / per-channel quant kernels against the PyTorch reference |
